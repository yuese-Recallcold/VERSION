    ...
    <el-form :model="form" :rules="rules" ref="ruleForm" label-width="120px" style="margin-right:30px;">
      ...
      <el-form-item label="项目" prop="project">
			  <el-select v-model="form.project" placeholder="请选择" clearable @change="handleChange">
					<el-option v-for="item in taskData.project" :key="item" :label="item" :value="item"></el-option>
				</el-select>
			</el-form-item>
      <el-form-item label="项目版本" prop="prversion" >
			  <el-select v-model="form.prversion" placeholder="请选择" clearable  @change="generateName">
					<el-option v-for="item in taskData.project_version" :key="item" :label="item" :value="item"></el-option>
				</el-select>
			</el-form-item>
      ...
      <el-form-item label="网络" prop="network">
			  <el-select v-model="form.network" placeholder="请选择" clearable  @change="generateName">
					<el-option v-for="item in form.network_list" :key="item" :label="item" :value="item"></el-option>
				</el-select>
			</el-form-item>
...
import { add, update ,get_config} from '@/api/table'
